...
<section>
<form class="box" action="../Controller/addven.php"onsubmit="return validation()" method="post">

      <div id="error_message"></div>
      <h1>Employee Registration</h1>
      <input type="text"id="uname" name="ouname" placeholder="Vendor Id" />
      <input type="text"id="user" name="pname" placeholder="Full Name" />
      <input type="text"id="mobileNumber" name="ophone" placeholder="Account Number">
		...
		function validation(){
      	...
      	var uid = document.getElementById('uname').value;
			...
			if(mobileNumber.length!=15){
				document.getElementById('error_message').innerHTML =" ** Mobile Number must be 15 digits only";
				return false;
			}
